      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          ...
          <div class="flex items-center space-x-4">
            <ThemeToggle />
            <router-link to="/settings" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 px-3 py-2 rounded-md text-sm font-medium">
              Settings
            </router-link>
...
const layout = ref([
  { x: 0, y: 0, w: 4, h: 20, i: 'documents', title: 'Knowledge Base', component: shallowRef(UnifiedDocumentList) },
  { x: 4, y: 0, w: 4, h: 20, i: 'actions', title: 'Quick Actions', component: shallowRef(QuickActions) },
  { x: 8, y: 0, w: 4, h: 8, i: 'upload', title: 'Upload File', component: shallowRef(FileUpload) },
  { x: 8, y: 8, w: 4, h: 12, i: 'retrieval', title: 'Ask Your Brain Vault', component: shallowRef(RetrievalTest) },
]);
