<template>
  <div class="min-h-screen bg-gray-50 dark:bg-app transition-colors duration-300 font-sans">
    <NavBar />
    ...
    <main class="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
      ...
      <!-- Tab Header -->
      <div class="border-b border-gray-200 dark:border-border mb-8 overflow-x-auto">
