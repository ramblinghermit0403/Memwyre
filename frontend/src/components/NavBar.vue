          ...
          <div class="relative ml-2" v-click-outside="closeProfile">
             ...
             >
                 <div v-if="isProfileOpen" class="absolute right-0 mt-2 w-48 bg-white dark:bg-elevated rounded-lg shadow-xl py-1 ring-1 ring-black ring-opacity-5 z-50 border border-gray-100 dark:border-border">
                     ...
                     <router-link to="/billing" class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-text-secondary hover:bg-gray-50 dark:hover:bg-surface-2 transition-colors">
                     ...
                     <router-link to="/settings" class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-text-secondary hover:bg-gray-50 dark:hover:bg-surface-2 transition-colors">
...
// Close profile automatically when route changes
watch(() => route.path, () => {
  closeProfile();
});
