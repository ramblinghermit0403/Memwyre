                    ...
                    <div class="flex items-start gap-3">
                      <div
                        ...
                        <img v-if="memory.source === 'claude'" src="@/assets/claude-color.svg"
                          class="w-full h-full object-cover" alt="Claude icon">
                        <img v-if="memory.source === 'gemini'" src="@/assets/gemini-color.svg"
                          class="w-full h-full object-cover" alt="Gemini icon">
                        <img v-if="memory.source === 'antigravity'"
                          src="@/assets/Google-Antigravity-Icon-Full-Color.png"
                          class="w-full h-full object-cover bg-white p-[2px] rounded-sm" alt="Google Antigravity icon">
        ...
        <div v-if="showDropdown"
          ...
          <div class="w-64 rounded-xl border border-white/10 bg-black shadow-2xl p-2">
            ...
            <button
              ...
              <img src="@/assets/claude-color.svg" class="w-5 h-5 shrink-0" alt="Claude logo" />
              Continue in Claude
            </button>
            <button
              class="w-full text-left text-sm font-medium px-3 py-2.5 hover:bg-white/5 rounded-lg flex items-center gap-3 text-white/80">
              <img src="@/assets/gemini-color.svg" class="w-5 h-5 shrink-0" alt="Gemini logo" />
              Continue in Gemini
            </button>
            <button
              class="w-full text-left text-sm font-medium px-3 py-2.5 hover:bg-white/5 rounded-lg flex items-center gap-3 text-white/80">
              <img src="@/assets/perplexity-color.svg" class="w-5 h-5 shrink-0" alt="Perplexity logo" />
          ...
          <div
            ...
            <div class="relative flex-none flex items-center gap-4 pl-3">
              ...
              <div class="w-8 h-8 flex items-center justify-center">
                <img src="/image.svg" class="w-5 h-5" alt="Memwyre Logo" />
              </div>
